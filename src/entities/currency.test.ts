...
describe('Currency', () => {
  ...
  describe('#equals', () => {
    it('rbtc on same chains is rbtc', () => {
      expect(RBTC.onChain(1).equals(RBTC.onChain(1)))
    })
    it('rbtc is not token0', () => {
      expect(RBTC.onChain(1).equals(t0)).toStrictEqual(false)
    })
